...
require_once locate_template('/NHP-Theme-Options-Framework-master/nhp-options.php');
...
function register_html5_menu()
{
    register_nav_menus(array( // Using array to specify more menus if needed
        'primary-menu' => __('Primary Menu', 'html5blank'), // Main Navigation
...
echo '<div class="bio-entry">';
		...
		echo '<div id="bio-avatar" class="col-left">';
		...
		echo '<div id="bio-text" class="col-left">';

			echo '<h3 class="bio-titles">';
			...
			echo '</h3>';
				...
				echo '<div class="bio-links">';
					...
					echo '<a class="view-articles" href="' . get_bloginfo('url') . '/user/';
					...
					echo '<a class="view-articles" href="' . get_bloginfo('url') . '/author/';
